...
\end{tcolorbox}
    ...
    \begin{figure}[!ht]
    	\centering
    	\adjustimage{max size={0.8\linewidth}}{images/data/cloudmoni_consulta}
    ...
    \begin{figure}[!ht]
        	\centering
        	\adjustimage{max size={0.8\linewidth}}{images/data/cloudmoni_contratar}
       ...
       \begin{figure}[!ht]
           	\centering
           	\adjustimage{max size={0.8\linewidth}}{images/data/cloudmoni_info}
       ...
       \begin{figure}[!ht]
           	\centering
           	\adjustimage{max size={0.8\linewidth}}{images/data/cloudmoni_queja}
    ...
    \begin{figure}[!ht]
               	\centering
               	\adjustimage{max size={0.8\linewidth}}{images/data/cloudmoni_tram}
...
\begin{figure}[!ht]
	\centering
	\adjustimage{max size={0.8\linewidth}}{images/data/cloudivr_ave}
...
\begin{figure}[!ht]
	\centering
	\adjustimage{max size={0.8\linewidth}}{images/data/cloudivr_baja}
...
\begin{figure}[!ht]
	\centering
	\adjustimage{max size={0.8\linewidth}}{images/data/cloudivr_comercial}
...
\begin{figure}[!ht]
	\centering
	\adjustimage{max size={0.8\linewidth}}{images/data/cloudivr_factura}
...
\begin{figure}[!ht]
	\centering
	\adjustimage{max size={0.8\linewidth}}{images/data/cloudivr_nrec}
...
\begin{figure}[!ht]
	\centering
	\adjustimage{max size={0.8\linewidth}}{images/data/cloudivr_recl}
...
\begin{figure}[!ht]
	\centering
	\adjustimage{max size={0.8\linewidth}}{images/data/cloudivr_resto}
...
En esta primera sección identificaremos los diferentes métodos que vamos a usar para representar las transcripciones. 
